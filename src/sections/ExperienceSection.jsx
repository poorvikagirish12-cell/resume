      ...
      <div className="split-layout reversed">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
          <div className="bento-card fade-up-element">
            <h4 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.2rem', color: 'var(--text-main)' }}>⚙️ Core Engineering</h4>
            <p style={{ color: 'var(--text-muted)', fontSize: '1rem', marginTop: '0.5rem', fontWeight: 500 }}>Python (Django, FastAPI), TypeScript, RESTful APIs, System Architecture</p>
          </div>

          <div className="bento-card fade-up-element" style={{ background: 'var(--color-10)', color: 'white', boxShadow: '0 0 20px rgba(14, 165, 233, 0.4)' }}>
            <h4 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.2rem', color: 'white' }}>🧠 AI & ML Engineering</h4>
            <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1rem', marginTop: '0.5rem', fontWeight: 500 }}>Computer Vision (OpenCV, YOLOv8), Data Analytics, Model Optimization, TensorFlow, PyTorch</p>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="bento-card fade-up-element" style={{ marginBottom: '1.5rem' }}>
            ...
            <ul style={{ color: 'var(--text-muted)', marginLeft: '1rem', marginTop: '1rem', lineHeight: '1.8', fontWeight: 500 }}>
              <li><strong>Engineered</strong> end-to-end web and AI-integrated applications using Python and the Django framework, focusing on clean architecture and scalable backend services.</li>
